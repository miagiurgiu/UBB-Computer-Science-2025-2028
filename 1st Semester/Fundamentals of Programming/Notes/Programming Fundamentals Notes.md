...
Documentation should live next to the code so that they are updated and work together + tools that allow to export to huma-readable formats like pdf -> see how the program works
